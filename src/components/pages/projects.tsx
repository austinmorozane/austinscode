...
description: "An audio recording engine that records audio into a .wav file and then allows for further compression, decompression, or uploading to a FireBase server. Types are type-checked for stability and efficiency in noisy environments.",
...
},
  {
  ...
  },
   {
    ...
    description: "An ecommerce website based on a wordPress original I built from scratch for a client with built-in layered SCSS animations, full mobile/desktop site transitions, mailChimp integration, support for purchases, add to cart, and more.",
    media:[
...
export const Projects: React.FC = () => {
    ...
    <div>
     ...
     <a className="projDesc" href="https://wavPlay.vercel.app" rel="noopener noreferrer">Audio Compressor Demo</a>
    <a className="projDesc" href="https://thevibecheck.onrender.com" rel="noopener noreferrer">The Vibe Check Demo</a>
      </div>
